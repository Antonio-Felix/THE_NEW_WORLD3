...
<body class="bodies">
    ...
    <div class="container">
        <div class="img-form">
            <img class="imagem" src="../../Imagens/login.png" alt="">
        </div>

        <div class="form">
            <form action="../captura/cap_cad_funcionario.php" method = "post">
                ...
                <div class="total-input">
                    <div class="labels">
                        <label for="cpffun"> <strong>CPF:</strong> </label>
                        <input type="number" name="cpffun" id="cpffun" autofocus placeholder="00000000000">
                    </div>
