    ...
    <body class="body-menu">
        ...
        <div class="logo-menu">
            ...
            <div class="div-btn-menu">
                <a href="cad_livro.php"><button type="submit" class="botao-menu"> Cadastrar </button></a>
            </div> 
            <div class="div-btn-menu">
                <a href="../listagem/acervo_lista.php"><button type="submit" class="botao-menu"> Listar Acervo </button></a>
            </div>
