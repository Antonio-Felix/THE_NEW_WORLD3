...
<body class="body-menu">
    ...
    <div class="logo-menu">
        ...
        <div class="div-btn-menu">
            <a href="cad_emp.php"><button type="submit" class="botao-menu"> Emprestimo </button></a>
        </div> 

        <div class="div-btn-menu">
            <a href="cad_devol.php"><button type="submit" class="botao-menu"> Devolução </button></a>
        </div> 

        <div class="div-btn-menu">
            <a href="cad_renova.php"><button type="submit" class="botao-menu"> Renovar </button></a>
        </div> 
    </div>
