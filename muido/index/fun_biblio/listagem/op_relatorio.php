    ...
    <body class="body-menu">
        ...
        <div class="logo-menu">
            ...
            <div class="div-btn-menu">
                <a href="lista_emp.php"><button type="submit" class="botao-menu"> Ver empréstimos </button></a>
            </div> 
            <div class="div-btn-menu">
                <a href="lista_devol.php"><button type="submit" class="botao-menu"> Ver devoluções </button></a>
            </div>
