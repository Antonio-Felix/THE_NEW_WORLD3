    ...
    <body class="body-menu">
        ...
        <div class="logo-menu">
            ...
            <div class="div-btn-menu">
                <a href="cadastro_leitor.php"><button type="submit" class="botao-menu" > Cadastrar </button></a>
            </div> 

            <div class="div-btn-menu">
                <a href="../listagem/lista_leitor.php"><button type="submit" class="botao-menu"> Listar Leitores </button></a>
            </div> 
